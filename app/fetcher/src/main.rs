...
use region::{Region, Regions, emilia_romagna::EmiliaRomagna, marche::Marche};
...
async fn main() -> Result<(), LambdaError> {
    ...
    let regions: Vec<Regions> = vec![
        Regions::EmiliaRomagna(EmiliaRomagna),
        Regions::Marche(Marche),
    ];
